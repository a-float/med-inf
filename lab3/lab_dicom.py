...
shiftScaleFilter.SetInputConnection(
    reader.GetOutputPort())     # input connection
...
actor.SetDisplayExtent(0, 255, 0, 255, 0, nFrames - 1)
actor.GetMapper().SetInputConnection(
    shiftScaleFilter.GetOutputPort())  # input connection
